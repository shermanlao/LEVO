...
- Used in the root header ([`frontend/src/app/layout.tsx`](../frontend/src/app/layout.tsx)) and [`Header.tsx`](../frontend/src/components/layout/Header.tsx). On `/admin` pages (not login), [`SiteNav`](../frontend/src/components/layout/SiteNav.tsx) keeps Home and shows Catalog, Projects, Settings, and Users with hover sub-menus.
